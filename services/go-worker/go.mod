module github.com/pulsarpoint/data-pipelines
...
require (
	...
	github.com/riverqueue/river v0.14.0 // indirect
	github.com/riverqueue/river/riverdriver v0.14.0 // indirect
	github.com/riverqueue/river/riverdriver/riverpgxv5 v0.14.0 // indirect
